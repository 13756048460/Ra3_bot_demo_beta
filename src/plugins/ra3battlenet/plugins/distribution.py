...
async def _(even: GroupMessageEvent, bot: Bot):
    ...
    records = requests.get("https://api.ra3battle.cn/api/stats/elo/distribution/ra3/1v1/")
    ...
    pyplot.savefig('C:/Users/Administrator/Desktop/yui/bkimg/bar_chart.png')
    imge = f"file://C:/Users/Administrator/Desktop/yui/bkimg/bar_chart.png"
